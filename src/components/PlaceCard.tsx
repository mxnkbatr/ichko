  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Photo */}
        <div className="w-full h-48 md:w-[120px] md:h-[90px] md:flex-none md:rounded-2xl overflow-hidden bg-zinc-100 dark:bg-zinc-800">
          <img
          ...
          />
          {/* Distance Badge */}
          <div className="absolute bottom-2 right-2 rounded-lg bg-black/60 px-2 py-1 text-[10px] font-black text-white backdrop-blur-md">
